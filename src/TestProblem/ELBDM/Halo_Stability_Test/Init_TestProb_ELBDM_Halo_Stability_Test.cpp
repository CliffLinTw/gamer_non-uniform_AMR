...
static double   Soliton_CM_TolErrR;                      // maximum allowed errors for determining CM
       double   Halo_Center[3];                          // center coordinates
// =======================================================================================
...
// ********************************************************************************************************************************
   ...
   ReadPara->Add( "Halo_CenterX",              &Halo_Center[0],             amr->BoxCenter[0], NoMin_double, NoMax_double      );
   ReadPara->Add( "Halo_CenterY",              &Halo_Center[1],             amr->BoxCenter[1], NoMin_double, NoMax_double      );
   ReadPara->Add( "Halo_CenterZ",              &Halo_Center[2],             amr->BoxCenter[2], NoMin_double, NoMax_double      );
...
// (4) make a note
   if ( MPI_Rank == 0 )
   {
      ...
      Aux_Message( stdout, "  halo central coordinate x                 = %13.7e\n", Halo_Center[0] );
      Aux_Message( stdout, "  halo central coordinate y                 = %13.7e\n", Halo_Center[1] );
      Aux_Message( stdout, "  halo central coordinate z                 = %13.7e\n", Halo_Center[2] );
      Aux_Message( stdout, "=============================================================================\n" );
   }
